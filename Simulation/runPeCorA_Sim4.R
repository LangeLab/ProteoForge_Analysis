...
for (pertRange in perturbationRanges){
        ...
        input_data_path <- paste0('./data/exp/', data_id, "/perturbationMags_", format(pertRange[1], nsmall = 1), "_", format(pertRange[2], nsmall = 1), "_InputData.feather")
        ...
        output_path <- paste0('./data/exp/', data_id,  "/perturbationMags_", format(pertRange[1], nsmall = 1), "_", format(pertRange[2], nsmall = 1),"_PeCorA_ModelResults.feather")
