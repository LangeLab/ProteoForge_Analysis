...
cat("Running COPF on the simulated data in", data_id, "folder with", perturb, "perturbation.\n")
...
for (version in dataVersions){
    ...
    output_path <- paste0('./data/exp/', data_id, "/", version, "_", perturb,  "_COPF_ModelResults.feather")
